...
namespace Services.Implements
{
    public class EsmsSmsService : ISmsService
    {
        ...
        public async Task SendSmsAsync(string toPhone, string message)
        {
            ...
            var url = $"http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?Phone={toPhone}&Content={message + " " + template}&ApiKey={_appSettings.Esms.ApiKey}&SecretKey={_appSettings.Esms.SecretKey}&Brandname=&SmsType=2";
