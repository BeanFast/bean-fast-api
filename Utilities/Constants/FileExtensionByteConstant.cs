...
{
    public class FileExtensionByteConstant
    {
        public static readonly Dictionary<string, List<byte[]>> ImageFileSignatures = new()
        {
        ...
        public static readonly Dictionary<string, List<byte[]>> SoundFileSignatures = new()
        {
            { ".mp3", new List<byte[]>
                {
                    new byte[] { 0xFF, 0xFB },
